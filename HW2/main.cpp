...
int main()
{
    ...
    // test insert_node(Int_Nodeode), delete_node(), operator<<, operator>>
    ...
    // test assignment operator, equality operator, insert_node(int, Int_Node), delete_node(int)
